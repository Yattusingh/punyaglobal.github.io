            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title"> : <span class="orange strong">Home New account</span></h1>               
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">   
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 profiel-container">
                      ...
                      <h4> <span class="orange strong" style="margin-left: 30%;" >${result} </span></h4>
                            ...
                            <div class="clear">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input name="p_email" type="email" class="form-control" placeholder="p-email@rmail.com">
                                    </div>
                                    <div class="form-group">
                                        <label>Phone :</label>
